...
<body class="homepage is-preload">
  ...
  function checkadmin() {
      var pwd = prompt("관리자 비밀번호를 입력하세요. (12345)");
      
      var admin_data = firebase.database().ref('admin_data');
				...
				<article class="box post">
					...
					<form id="form1" method="POST">
						...
						<input type="button" onclick="myjsplogin()" value="로그인"
							class="button alt"> <input type="button"
							onclick="gosignup()" value="회원가입" class="button alt"><br>
